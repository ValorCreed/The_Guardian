package com.vault.theguardian.emailservice.common;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidation(
        ...
        String message = exception.getBindingResult().getFieldErrors().stream()
                ...
                .orElse("Some email details are missing or invalid.");
    ...
    public ResponseEntity<Map<String, Object>> handleUnexpected(
        ...
        log.error("Unhandled email request failure path={}", request.getRequestURI(), exception);
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(body("INTERNAL_ERROR", "Email delivery failed unexpectedly.",
                        request.getRequestURI()));
    }
