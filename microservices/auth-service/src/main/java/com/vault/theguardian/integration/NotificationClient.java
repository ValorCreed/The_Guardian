package com.vault.theguardian.integration;
...
public class NotificationClient {
    ...
    public void notifySubscriptionActivated(User user, SubscriptionPlan plan, LocalDateTime expiresAt) {
        ...
        createNotification(user, "SUBSCRIPTION_ACTIVATED", planLabel + " activated",
                "Your " + planLabel + " plan is now active " + expiryText + ".", "/subscription");
    }

    public void notifySubscriptionCancelled(User user) {
        createNotification(user, "SUBSCRIPTION_CANCELLED", "Subscription cancelled",
                "Your paid plan has been cancelled and your account has returned to Free.", "/subscription");
    }
