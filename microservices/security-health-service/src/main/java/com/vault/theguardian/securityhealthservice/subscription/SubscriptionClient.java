package com.vault.theguardian.securityhealthservice.subscription;
...
public class SubscriptionClient {
    ...
    public boolean canUseBreachMonitoring(Long userId) {
        SubscriptionEntitlements entitlements = getEntitlements(userId);
        return entitlements.active() && entitlements.canUseBreachMonitoring();
    }
