...
const makeStyles = (C: any) => StyleSheet.create({
  ...
  iconCircle: { width: 76, height: 76, borderRadius: 38, backgroundColor: C.actionCard, alignItems: 'center', justifyContent: 'center', marginBottom: 18 },
  ...
  card: { backgroundColor: C.backgroundElement, borderRadius: 20, borderWidth: 1, borderColor: C.border, padding: 16, marginBottom: 16 },
  ...
  noticeBox: { backgroundColor: C.actionCard, borderRadius: 16, padding: 14, flexDirection: 'row', gap: 10, marginBottom: 18 },
  noticeText: { color: C.primary, flex: 1, fontSize: 13, lineHeight: 19, fontWeight: '700' },
  sendButton: { backgroundColor: C.backgroundbutton, borderRadius: 999, paddingVertical: 17, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
