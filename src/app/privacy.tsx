...
const makeStyles = (C: any) => StyleSheet.create({
 ...
 backgroundColor: C.alertWarningBg, borderRadius: 24, borderWidth: 1, borderColor: C.border, padding: 16, marginBottom: 18 },
  ...
  card: {
    ...
    elevation: 10,
    shadowOffset: { width: 0, height: 12 },
 flexDirection: 'row', backgroundColor: C.backgroundElement, borderRadius: 26, borderWidth: 1, borderColor: C.border, padding: 16, marginBottom: 14 },
  cardIcon: {
    shadowColor: '#000000',
    shadowOpacity: 0.2,
    shadowRadius: 22,
 ...
 height: 54, borderRadius: 22, backgroundColor: C.primary, alignItems: 'center', justifyContent: 'center' },
