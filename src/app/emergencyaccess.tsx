...
const makeStyles = (C: any) => StyleSheet.create({
  ...
  heroCard: { backgroundColor: C.backgroundElement, borderRadius: 24, padding: 18, borderWidth: 1, borderColor: C.border, flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 14 },
  ...
  actionButton: { flex: 1, backgroundColor: C.backgroundbutton, borderRadius: 999, paddingVertical: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  disabledAction: { opacity: 0.55 },
  actionButtonText: { color: '#fff', fontSize: 14, fontWeight: '900' },
  secondaryAction: { flex: 1, backgroundColor: C.actionCard, borderRadius: 999, paddingVertical: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  secondaryActionText: { color: C.primary, fontSize: 14, fontWeight: '900' },
  upgradeCard: { backgroundColor: C.securityScoreBg, borderRadius: 16, borderWidth: 1, borderColor: C.warning, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 12 },
  upgradeText: { color: C.warning, flex: 1, fontSize: 13, fontWeight: '800', lineHeight: 18 },
  card: { backgroundColor: C.backgroundElement, borderRadius: 20, borderWidth: 1, borderColor: C.border, overflow: 'hidden', marginBottom: 16 },
