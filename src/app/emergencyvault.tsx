...
const makeStyles = (C: any) => StyleSheet.create({
  ...
  skeletonIcon: { width: 42, height: 42, borderRadius: 18 },
  ...
  heroCard: { backgroundColor: C.backgroundElement, borderRadius: 26, padding: 18, borderWidth: 1, borderColor: C.border, flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 16 },
  heroIcon: { width: 56, height: 56, borderRadius: 30, backgroundColor: C.actionCard, alignItems: 'center', justifyContent: 'center' },
  heroTitle: { color: C.text, fontSize: 17, fontWeight: '900' },
  heroSub: { color: C.textSecondary, fontSize: 13, marginTop: 4 },
  countPill: { minWidth: 36, height: 36, borderRadius: 20, backgroundColor: C.primary, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 },
  ...
  listCard: { backgroundColor: C.backgroundElement, borderRadius: 22, borderWidth: 1, borderColor: C.border, overflow: 'hidden', marginBottom: 16 },
  ...
  iconCircle: { width: 42, height: 42, borderRadius: 18, backgroundColor: C.actionCard, alignItems: 'center', justifyContent: 'center' },
  itemTitle: { color: C.text, fontSize: 15, fontWeight: '900' },
  itemSub: { color: C.textSecondary, fontSize: 12, lineHeight: 17, marginTop: 3 },
  emptyBox: { backgroundColor: C.backgroundElement, borderRadius: 24, borderWidth: 1, borderColor: C.border, padding: 22, alignItems: 'center', gap: 8 },
