      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.passwordRow}>
            ...
            >
              <Ionicons name="refresh-outline" size={20} color="#1a5c35" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.generatorCard}>
            <View style={styles.generatorHeader}>
              <Ionicons name="refresh-outline" size={18} color="#1a5c35" />
            ...
            <View style={styles.sliderRow}>
              ...
              <View style={styles.sliderControls}>
                ...
                >
                  <Ionicons name="remove" size={18} color="#1a5c35" />
                </TouchableOpacity>
                ...
                >
                  <Ionicons name="add" size={18} color="#1a5c35" />
                </TouchableOpacity>
              </View>
            </View>
            ...
            <View style={styles.toggleRow}>
              ...
              <Switch
                ...
                trackColor={{ false: '#ddd', true: '#1a5c35' }}
                thumbColor="#fff"
              />
            </View>
